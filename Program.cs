...
// int nahodnyDen = Random.Shared.Next(1, 31);
// int nahodnyRok = Random.Shared.Next(-10000, 2025);
// int nahodnyMesic = Random.Shared.Next(1, 12);

// int nahodnyDenMatky = Random.Shared.Next(1, 31);
// int nahodnyMesicMatky = Random.Shared.Next(1, 12);
// int nahodnyDenTatky = Random.Shared.Next(1, 31);
